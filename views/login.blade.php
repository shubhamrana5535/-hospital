...
<div class="container m-5 " >
    <div class="row">
        ...
        <div class="col-md-6" style="background:#D433FF">
    ...
    <div class="form-group">
    <button type="submit" value="submit" class="btn btn-success inline-block mt-2" >submit</button> 
    <button class="btn btn-info mt-2"> <a href="register">Register</a></button>
